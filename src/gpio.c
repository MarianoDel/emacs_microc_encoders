...
void GpioInit (void)
{
    ...
    temp = GPIOA->ODR;    // PA1 - PA7 pull-up;
    temp &= 0xFF01;       // 
    temp |= 0x00FE;
    GPIOA->ODR = temp;
    ...
    //PB8 EN_DT_8 input
    //PB9 NC
    //PB10 alternative I2C2_SCL
    //PB11 alternative I2C2_SDA
    //PB12 EN_SW_6 input
    //PB13 EN_CK_6 input
    //PB14 EN_DT_6 input
    //PB15 EN_SW_5 input
    ...
    temp = GPIOB->ODR;    // PB0 - PB2 pullup; PB5 pullup
    temp &= 0x0ED8;       // PB8 pullup; PB12 - PB15 pullup
    temp |= 0xF127;
    GPIOB->ODR = temp;
    ...
    temp = GPIOC->ODR;    // PC4 - PC7 pullup
    temp &= 0xE30F;       // PC10 - PC12 pullup
    temp |= 0x1CF0;
    GPIOC->ODR = temp;
